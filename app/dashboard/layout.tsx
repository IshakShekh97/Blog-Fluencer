  ...
  return (
    <>
      ...
      <section className=" grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
        <div className="hidden border-secondary bg-muted/40 md:block">
          <div className="flex h-full max-h-screen flex-col gap-2 ">
            ...
            <div className="flex-1 flex-col border-r flex justify-between">
              ...
              <div className="">
                <div className="mb-5 mx-3 bg-secondary-foreground text-secondary backdrop-blur-3xl backdrop-brightness-200 px-3 py-2 rounded-lg flex items-center justify-between">
                  <Link
                    target="_blank"
